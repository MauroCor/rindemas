    ...
    <div className="dark bg-gray-900 min-h-screen">
      <div className="relative p-1">
        ...
        <div className='flex justify-center items-center flex-wrap space-x-2 mt-6'>
          <ButtonComponent text="⬅️" onClick={handlePrev} className='hover:bg-blue-500 text-2xl' />
          <div className='pl-16' />
          <ButtonComponent text="Ver actual" onClick={focusCurrentMonth} className='hover:bg-blue-500 px-2 py-0 bg-gray-600 border-gray-950' />
          <DropdownItemsPerPageComponent itemsPerPage={itemsPerPages} onItemsPerPageChange={handleItemsPerPageChange} />
          <div className='pl-16' />
          <ButtonComponent text="➡️" onClick={handleNext} className='hover:bg-blue-500 text-2xl' />
        </div>
